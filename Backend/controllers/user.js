...
export const signin = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ result: oldUser, token ,message:"Success"});
    } catch (err) {
...
export const signup = async (req, res) => {
    ...
    try {
        ...
        const result = await UserModal.create({ firstName,lastName,userName, password: hashedPassword,Email,PhoneNumber,MobileNumber,state,country, name: `${firstName} ${lastName}` });
